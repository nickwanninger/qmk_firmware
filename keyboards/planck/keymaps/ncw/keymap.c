...
enum planck_layers { _QWERTY, _LOWER, _RAISE, _ADJUST, _EMOD, _FUNCT };
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Alt |  GUI | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, FUNCT,   LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
// This is my typical EMOD thing (Hold escape for another layer,
// tap for escape). It's just muscle memory at this point
...
[_FUNCT] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, KC_PPLS, KC_KP_4, KC_KP_5, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_DOT,  _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
